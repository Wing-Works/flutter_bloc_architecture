...
echo ========================================
echo Flutter Bundle Release Build Script
echo ========================================
echo.
...
set "TEMP_ERROR=%TEMP%\flutter_bundle_error_%RANDOM%.txt"

echo Starting Bundle release build process...
echo.
...
:: Step 3: Build Bundle Release
echo ----------------------------------------
echo Step 3: Building Bundle release
echo ----------------------------------------
echo.

echo - Building Bundle release...
call flutter build appbundle --release >nul 2>"%TEMP_ERROR%"
if errorlevel 1 (
    echo   ERROR: Failed to build Bundle release
    echo   Error details:
    if exist "%TEMP_ERROR%" (
        type "%TEMP_ERROR%"
        del "%TEMP_ERROR%" >nul 2>&1
...
echo   SUCCESS: Bundle release built successfully
echo.

:: Success message
echo ========================================
echo SUCCESS: Bundle release build completed successfully!
echo ========================================
echo.
echo Built Bundle location:
...
:error
echo ========================================
echo ERROR: Bundle build process failed!
echo ========================================
